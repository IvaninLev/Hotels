...
class TourIndexPage extends IndexPage
{
    ...
    protected function fields(): iterable
    {
        return [
            ...
            Text::make('Name', 'name'),
            Text::make('Hotel', 'hotel.name'),
            Text::make('Country', 'country.name'),
            Text::make('City', 'city.name'),
            Number::make('Base price', 'base_price')->prefix('$'),
            Number::make('Persons', 'persons'),
            Image::make('Images', 'images')->multiple(),
            Date::make('Active from', 'active_from')->format('d.m.Y H:i'),
            Date::make('Active to', 'active_to')->format('d.m.Y H:i'),
